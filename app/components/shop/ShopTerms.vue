...
<template>
  <div class="mb-4 rounded bg-[#f68b08] px-4 py-2 text-center text-white">
    {{ t("Please make sure to read our shop") }}
    <button
      class="min-h-0 border-0 bg-transparent p-0 font-bold underline"
      @click="termsDialog?.showModal()"
    >
      {{ t("Terms & Conditions") }}
    </button>
